...
public class TestRequetes {
	...
	public void test_UtilisateurRepository_findByPseudo() {
		...
		final Optional<Utilisateur> optionalUtilisateur = utilisateurRepository.findByPseudo(pseudo);

		// Vérification
		assertThat(optionalUtilisateur).isPresent();
		assertThat(optionalUtilisateur.get().getPseudo()).isNotNull();
		assertThat(optionalUtilisateur.get().getPseudo()).isEqualTo(pseudo);
	}
	...
	public void test_UtilisateurRepository_findByPseudoAndPassword() {
		...
		final Optional<Utilisateur> optionalUtilisateur = utilisateurRepository.findByPseudoAndPassword(pseudo, pwd);

		// Vérification
		assertThat(optionalUtilisateur).isPresent();
		assertThat(optionalUtilisateur.get().getPseudo()).isNotNull();
		assertThat(optionalUtilisateur.get().getPseudo()).isEqualTo(pseudo);
		assertThat(optionalUtilisateur.get().getPassword()).isNotNull();
		assertThat(optionalUtilisateur.get().getPassword()).isEqualTo(pwd);
	}
